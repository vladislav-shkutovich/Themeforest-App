...
export const FAQS_PAGE_CARDS: IFAQsContentCard[] = [
	{
		id: 'data_analytics',
		title: 'What are data analytics?',
		text: 'Phasellus tristique eu nisl eu consectetur. Morbi urna massa, imperdiet in mauris et, euismod vestibulum lacus. Integer enim elit, tincidunt aliquam ligula id, lacinia auctor orci. Sed quis lobortis eros.',
		isOpen: false,
	},
	{
		id: 'data_mining',
